...
public class DonorRepository implements IDonorRepository<Donor,Integer>{
        ...
        try(PreparedStatement preparedStatement = connection.prepareStatement("select * from Donors where id = ?")){
            ...
            try(ResultSet resultSet = preparedStatement.executeQuery()){
                if(resultSet.next()){
                    ...
                    Donor donor = new Donor(idDonor,firstNameDonor,lastNameDonor,addressDonor,phoneNumberDonor);
