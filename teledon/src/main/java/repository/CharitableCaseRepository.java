...
public class CharitableCaseRepository implements ICharitableCaseRepository<CharitableCase,Integer> {
    ...
    public void update(CharitableCase elem, Integer id) {
        ...
        Connection connection = dbUtils.getConnection();
        String sql = String.format("update CharitableCases set name = ?, amountRaised = ? where id = %d",id);
