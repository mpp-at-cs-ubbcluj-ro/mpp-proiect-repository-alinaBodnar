...
{
    class DonorRepository : IDonorRepository<int, Donor>
    {
            ...
            using (var comm = con.CreateCommand())
            {
                ...
                using (var dataR = comm.ExecuteReader())
                {
                    while (dataR.Read())
                    {
                        ...
                        Donor donor = new Donor(idD, firstNameD, lastNameD, addressD, phoneNumberD);
                        donors.Add(donor);
                    }
                }
            }
        ...
        public void save(Donor el)
        {
            ...
            using(var comm=con.CreateCommand())
            {
                comm.CommandText = "insert into Donors values(@firstName,@lastName,@address,@phoneNumber)";
