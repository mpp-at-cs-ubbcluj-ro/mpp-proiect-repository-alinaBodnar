...
{
    class VolunteerRepository : IVolunteerRepository<int, model.Volunteer>
    {
        ...
        public void delete(int key)
        {
            ...
            {
                comm.CommandText = "delete from Volunteer where id = @key";
        ...
        public List<Volunteer> findAll()
        {
            ...
            using (var comm = con.CreateCommand())
            {
                comm.CommandText = "select id,username,password from Volunteer";
